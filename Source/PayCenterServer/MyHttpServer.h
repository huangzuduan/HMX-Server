...
public:
	...
	uint64_t GetKeyValueInt(const std::string& keyName, const std::map<std::string, std::string>& params);
	void getRequestArgs(const HTTPServerRequest &req, std::map<std::string,std::string>& params);
