#ifndef __MAJIANG_RULE_XZ_TDH_H__
#define __MAJIANG_RULE_XZ_TDH_H__
 ...
 * 河源推倒胡麻将
 */
class CMajingRuleXZ : public CMajingRule
{
public:
	CMajingRuleXZ(CRoom* pRoom, const ::msg_maj::RoomOption& roomOption);
	virtual ~CMajingRuleXZ();
	...
	virtual ::msg_maj::hu_way GetHuWayGangShanPao() const { return ::msg_maj::hu_way_xz_gangshangpao; };
	virtual ::msg_maj::hu_way GetHuWayQiangGangHu() const { return ::msg_maj::hu_way_xz_qiangganghu; };
	virtual ::msg_maj::hu_way GetHuWayGangKaiHua() const { return ::msg_maj::hu_way_xz_gangkaihua; };
