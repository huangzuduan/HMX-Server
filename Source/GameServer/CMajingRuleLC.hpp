#ifndef __MAJIANG_RULE_LC_TDH_H__
#define __MAJIANG_RULE_LC_TDH_H__
 ...
 * 河源推倒胡麻将
 */
class CMajingRuleLC : public CMajingRule
{
public:
	CMajingRuleLC(CRoom* pRoom,const ::msg_maj::RoomOption& roomOption);
	virtual ~CMajingRuleLC();
