#ifndef __MAJIANG_RULE_BB_TDH_H__
#define __MAJIANG_RULE_BB_TDH_H__
 ...
 * 河源推倒胡麻将
 */
class CMajingRuleBB : public CMajingRule
{
public:
	CMajingRuleBB(CRoom* pRoom,const ::msg_maj::RoomOption& roomOption);
	virtual ~CMajingRuleBB();
