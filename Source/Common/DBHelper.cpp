	...
	const std::string & tableName)
{
	...
	{
		printf("Check table %s exist in database %s  failed, errno %d, error message %s , SQL:%s \n", tableName.c_str() , dbName.c_str(), mysql_errno(&mysql) , mysql_error(&mysql), sql.c_str());
		return false;
	}
