...
class TestDeprecatedLite : public ::google::protobuf::MessageLite {
 public:
  ...
  PROTOBUF_DEPRECATED_ATTR bool has_deprecated_field() const;
  PROTOBUF_DEPRECATED_ATTR void clear_deprecated_field();
  PROTOBUF_DEPRECATED_ATTR static const int kDeprecatedFieldFieldNumber = 1;
  PROTOBUF_DEPRECATED_ATTR ::google::protobuf::int32 deprecated_field() const;
  PROTOBUF_DEPRECATED_ATTR void set_deprecated_field(::google::protobuf::int32 value);
...
class V1MessageLite : public ::google::protobuf::MessageLite {
 public:
  V1MessageLite();
...
class V2MessageLite : public ::google::protobuf::MessageLite {
 public:
  V2MessageLite();
