...
class TestDiffMessage : public ::google::protobuf::Message {
 public:
  ...
  PROTOBUF_DEPRECATED_ATTR bool has_v() const;
  PROTOBUF_DEPRECATED_ATTR void clear_v();
  PROTOBUF_DEPRECATED_ATTR static const int kVFieldNumber = 13;
  PROTOBUF_DEPRECATED_ATTR ::google::protobuf::int32 v() const;
  PROTOBUF_DEPRECATED_ATTR void set_v(::google::protobuf::int32 value);
  ...
  PROTOBUF_DEPRECATED_ATTR int rm_size() const;
  PROTOBUF_DEPRECATED_ATTR void clear_rm();
  PROTOBUF_DEPRECATED_ATTR static const int kRmFieldNumber = 12;
  PROTOBUF_DEPRECATED_ATTR const ::protobuf_unittest::TestField& rm(int index) const;
  PROTOBUF_DEPRECATED_ATTR ::protobuf_unittest::TestField* mutable_rm(int index);
  PROTOBUF_DEPRECATED_ATTR ::protobuf_unittest::TestField* add_rm();
  PROTOBUF_DEPRECATED_ATTR ::google::protobuf::RepeatedPtrField< ::protobuf_unittest::TestField >*
      mutable_rm();
  PROTOBUF_DEPRECATED_ATTR const ::google::protobuf::RepeatedPtrField< ::protobuf_unittest::TestField >&
      rm() const;
